...
@Composable
fun MainScreen(modifier: Modifier = Modifier, darkTheme : Boolean, onThemeChange : (Boolean) -> Unit) {
    ...
    Scaffold(
        ...
        when (selectedItem) {
            ...
            "Setting" -> SettingPage(modifier = Modifier.padding(innerPadding).fillMaxSize(),
                darkTheme = darkTheme,
